...
class AsyncVideoService(
    ...
    @org.springframework.beans.factory.annotation.Value("\${app.feature.remote-rendering:false}") private val isRemoteRendering: Boolean,
    ...
    fun createVideoAsync(news: NewsItem, historyId: String, targetChannelId: String? = null): CompletableFuture<String> {
        ...
        if (isRemoteRendering) {
            ...
            // Mark as QUEUED provided historyId is already created by controller
            return CompletableFuture.completedFuture("QUEUED_REMOTE")
        }

        // V1: Local Monolithic Execution
